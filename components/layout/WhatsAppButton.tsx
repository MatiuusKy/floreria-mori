  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <div className="relative group flex flex-col items-end">
        ...
        <div className="absolute bottom-full mb-2 right-0 opacity-0 group-hover:opacity-100 transition-opacity duration-200 bg-white text-gray-700 text-xs font-medium px-3 py-2 shadow-md whitespace-nowrap pointer-events-none" style={{ borderRadius: '4px' }}>
